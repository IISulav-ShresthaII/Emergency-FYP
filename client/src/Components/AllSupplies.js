...
// export default function AllSupplies() {
...
//   useEffect(() => {
//     Axios({
//       url: "http://localhost:4000/supplies",
//       method: "GET",
//     })
//       .then((response) => {
...
//           if (supplies.type === "Donation") {
//             let user = false;
//             if (supplies.userId === user_info._id) {
//               user = true;
//             }
...
//                       <Button
//                         component={Link}
//                         to={`/${supplies.name}?cid=${supplies._id}&type=${supplies.type}/${user}`}
//                         variant={"contained"}
//                         color="primary"
//                         sx={{
//                           textTransform: "none",
